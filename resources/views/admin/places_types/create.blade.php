                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-7">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.place_type.index') }}">Places Types / </a> {{  !isset($place_type->place_type_id)  ? 'Add / ' : "Edit / ". $place_type->place_type_name }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
